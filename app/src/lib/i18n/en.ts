...
const en: TranslationMap = {
  ...
  'settings.developerMenu.terminal.title': 'Terminal',
  'settings.developerMenu.terminal.desc':
    'Open a local or SSH-backed interactive PTY session with user-visible controls',
  ...
  'terminal.description':
    'Start a local shell or SSH PTY session. You can type directly, and approved AI actions can share the same session.',
  'terminal.welcome': 'OpenHuman terminal ready. Start a session to begin.',
  'terminal.starting': 'Starting terminal session...',
  'terminal.closed': 'Terminal session closed.',
  'terminal.errorPrefix': 'Terminal error:',
  'terminal.kind': 'Session type',
  'terminal.kind.local': 'Local shell',
  'terminal.kind.ssh': 'SSH',
  'terminal.command': 'Local command',
  'terminal.commandPlaceholder': 'Optional, e.g. python or npm run dev',
  'terminal.sshHost': 'SSH host',
  'terminal.sshHostPlaceholder': 'server.example.com',
  'terminal.sshUser': 'SSH user',
  'terminal.sshUserPlaceholder': 'Use SSH config default',
  'terminal.sshPort': 'Port',
  'terminal.approvalHint':
    'I approve starting this terminal session. SSH and explicit commands are audited and may run remote or local side effects.',
  ...
  'terminal.pid': 'PID',
  'terminal.start': 'Start session',
  'terminal.startingButton': 'Starting...',
